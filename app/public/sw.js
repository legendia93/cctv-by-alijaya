const CACHE_NAME = 'cctv-monitor-v5';
const STATIC_CACHE = 'cctv-static-v5';
const DYNAMIC_CACHE = 'cctv-dynamic-v5';
...
self.addEventListener('fetch', (event) => {
    ...
    // 3a. CSS & JS - Network First (agar perubahan tema/UI langsung terlihat
    //     tanpa hard-reload; cache hanya fallback saat offline)
    ...
    // 3b. Images - Cache First (aman di-cache lama; jarang berubah)
