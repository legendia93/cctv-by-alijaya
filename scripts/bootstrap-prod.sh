...
echo "       ssh $SERVER_USER@$SERVER_HOST \"docker exec lookna node -e \\\"const w=require('web-push');console.log(JSON.stringify(w.generateVAPIDKeys(),null,2))\\\" > $SERVER_DIR/data/vapid-keys.json && docker restart lookna\""
echo "============================================"
